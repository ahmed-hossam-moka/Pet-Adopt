...
namespace PetAdopt.DAL.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "AdopterHistories",
                columns: table => new
                {
                    HistoryId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AdopterId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    PreviousPetName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    PreviousPetType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    VeterinaryReference = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    Experience = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    YearOfAdoption = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdopterHistories", x => x.HistoryId);
                    table.ForeignKey(
                        name: "FK_AdopterHistories_AspNetUsers_AdopterId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HealthStatus = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdopterHistories_AdopterId",
                table: "AdopterHistories",
                column: "AdopterId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdoptionRequests_PetId_AdopterId",
                table: "AdoptionRequests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_ReviewerId_PetId",
                table: "Reviews",
                columns: new[] { "ReviewerId", "PetId" },
                unique: true);
        }
